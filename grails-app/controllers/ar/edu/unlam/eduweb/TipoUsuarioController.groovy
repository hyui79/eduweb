...
class TipoUsuarioController {
    ...
    def save(TipoUsuario tipoUsuarioInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.created.message', args: [message(code: 'tipoUsuarioInstance.label', default: 'TipoUsuario'), tipoUsuarioInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'tipoUsuarioInstance.label', default: 'TipoUsuario'), params.id])
                redirect action: "index", method: "GET"
            }
