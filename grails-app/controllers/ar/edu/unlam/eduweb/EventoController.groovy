...
class EventoController {
    ...
    def save(Evento eventoInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.created.message', args: [message(code: 'eventoInstance.label', default: 'Evento'), eventoInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'eventoInstance.label', default: 'Evento'), params.id])
                redirect action: "index", method: "GET"
            }
