	...
	<body>
		...
		<div id="show-tipoUsuario" class="content scaffold-show" role="main">
			...
			<ol class="property-list tipoUsuario">
				...
				<g:if test="${tipoUsuarioInstance?.tipoUs}">
				<li class="fieldcontain">
					<span id="tipoUs-label" class="property-label"><g:message code="tipoUsuario.tipoUs.label" default="Tipo Us" /></span>
					
						<span class="property-value" aria-labelledby="tipoUs-label"><g:fieldValue bean="${tipoUsuarioInstance}" field="tipoUs"/></span>
