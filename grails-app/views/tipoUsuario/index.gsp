		...
		<div id="list-tipoUsuario" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="tipoUs" title="${message(code: 'tipoUsuario.tipoUs.label', default: 'Tipo Us')}" />
				...
				<g:each in="${tipoUsuarioInstanceList}" status="i" var="tipoUsuarioInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${tipoUsuarioInstance.id}">${fieldValue(bean: tipoUsuarioInstance, field: "tipoUs")}</g:link></td>
