		...
		<div id="list-prueba" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="prueba.curso.label" default="Curso" /></th>
					
						<g:sortableColumn property="nombre" title="${message(code: 'prueba.nombre.label', default: 'Nombre')}" />
				...
				<g:each in="${pruebaInstanceList}" status="i" var="pruebaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${pruebaInstance.id}">${fieldValue(bean: pruebaInstance, field: "curso")}</g:link></td>
					
						<td>${fieldValue(bean: pruebaInstance, field: "nombre")}</td>
