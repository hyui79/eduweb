	...
	<body>
		...
		<div id="show-estadoActividad" class="content scaffold-show" role="main">
			...
			<ol class="property-list estadoActividad">
				...
				<g:if test="${estadoActividadInstance?.estadoAct}">
				<li class="fieldcontain">
					<span id="estadoAct-label" class="property-label"><g:message code="estadoActividad.estadoAct.label" default="Estado Act" /></span>
					
						<span class="property-value" aria-labelledby="estadoAct-label"><g:fieldValue bean="${estadoActividadInstance}" field="estadoAct"/></span>
