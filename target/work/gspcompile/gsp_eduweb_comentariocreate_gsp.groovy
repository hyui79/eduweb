...
class gsp_eduweb_comentariocreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',25,['bean':(comentarioInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(comentarioInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
invokeTag('form','g',35,['url':([resource:comentarioInstance, action:'save'])],2)
printHtmlPart(22)
})
