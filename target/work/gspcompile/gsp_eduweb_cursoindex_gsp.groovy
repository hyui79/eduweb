...
class gsp_eduweb_cursoindex_gsp extends GroovyPage {
...
printHtmlPart(12)
invokeTag('sortableColumn','g',27,['property':("nombre"),'title':(message(code: 'curso.nombre.label', default: 'Nombre'))],-1)
printHtmlPart(13)
loop:{
int i = 0
...
invokeTag('link','g',35,['action':("show"),'id':(cursoInstance.id)],3)
printHtmlPart(16)
i++
}
}
printHtmlPart(17)
invokeTag('paginate','g',42,['total':(cursoInstanceCount ?: 0)],-1)
printHtmlPart(18)
})
