...
class gsp_eduweb_eventocreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',25,['bean':(eventoInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(eventoInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
invokeTag('form','g',35,['url':([resource:eventoInstance, action:'save'])],2)
printHtmlPart(22)
})
